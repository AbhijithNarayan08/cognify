...
export function AppProvider({ children }) {
  ...
  useEffect(() => {
    if (hydrated) {
      const { workoutComplete, workoutInProgress, checkins, checkinDismissedAt, streakDays, lastWorkoutDate, lastCheckinDate, customFruits } = state;
      saveSession({ workoutComplete, workoutInProgress, checkins, checkinDismissedAt, streakDays, lastWorkoutDate, lastCheckinDate, customFruits });
    }
  }, [
